<?php get_header()?>
    ...
    <?php global $wp_query,$paged;
          $tema_cat = $category_name;
          $per_page = 6;
          $paged = get_query_var('paged')+1;

         $paged = ($paged == ""? 0 : $paged );?>
         <?php  query_posts(array_merge($wp_query->query, array(
            'category_name'         => $tema_cat,
            'paged'          => $paged,
            'posts_per_page' => $per_page)));?>
          <script type="text/javascript">
          paged = <?php echo $paged;?>;num_pages=<?php echo $wp_query->max_num_pages;?>; term_name='<?php echo $tema_cat;?>';
          </script>
          <?php 
